...
public class YBAlertController: UIViewController, UIGestureRecognizerDelegate {
    ...
    // titleLabel
    public var titleFont = UIFont(name: "OpenSans-SemiBold", size: 17)
    public var titleTextColor = UIColor.black

    // message
    public var message:String?
    public var messageLabel = UILabel()
    public var messageFont = UIFont(name: "OpenSans-Regular", size: 15)
    ...
    public var buttonFont = UIFont(name: "OpenSans-Regular", size: 15)

    // cancelButton
    public var cancelButtonTitle:String?
    public var cancelButtonFont = UIFont(name: "OpenSans-Regular", size: 13)
    ...
    public init() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(changedOrientation), name: nil, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(changedOrientation), name: nil, object: nil)
    }
